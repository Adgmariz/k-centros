...
filepath = 'datasets/yeast/yeast.data'
output_file = 'yeast.csv'
k = 10
numbers_per_line = 9 #including the class
...
col_names = ['toDrop'] + [str(i) for i in range(numbers_per_line - 2)] + ['class']
class_to_id = {
    'CYT': 0, 
    'NUC': 1, 
    'MIT': 2, 
...
df.iloc[:, -1] = df.iloc[:, -1].map(class_to_id)
